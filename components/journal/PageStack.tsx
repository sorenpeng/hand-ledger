...
const journalPages = [
          ...
          <div className="flex-1 grid grid-cols-2 gap-6">
            ...
            <div className="flex flex-col items-center gap-2">
              ...
              <Envelope size="sm" color="vintage">
                <Letter>
                  <p className="handwriting text-ink-sepia">
                    Dear friend, treasure every moment...
                  </p>
                </Letter>
              </Envelope>
            </div>
    ...
    frontContent: (
      <div className="p-4 h-full overflow-hidden">
        ...
        <div className="flex flex-wrap gap-3 items-start">
          ...
          {/* Stamp collection */}
          <StampCollection className="scale-75 origin-top-left" />

          {/* Music scrap */}
          <MusicScrap width={100} height={70} rotation={-5} />

          {/* Receipt */}
          <Receipt variant="ticket" width={80} rotation={3} />
        </div>
      </div>
    ),
    backContent: (
      <div className="p-4 h-full overflow-hidden">
        ...
        <div className="flex flex-wrap gap-4 items-start">
          ...
          {/* Old photo */}
          <OldPhoto width={80} height={60} style="polaroid" caption="Summer '23" />

          {/* Postcard */}
          <Postcard message="Having a wonderful time!" to="Dear Friend" rotation={-3} />
  ...
  },
  {
    ...
    backContent: (
      <div className="p-8 h-full flex items-center justify-center">
        <div className="text-center">
          <p className="typewriter text-ink-faded/40 text-xs">back cover</p>
        </div>
      </div>
    ),
  },
